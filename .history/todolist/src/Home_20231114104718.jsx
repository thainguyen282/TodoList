...
function Home() {
    ...
    const handleStatEdit = async (id) => {
        try {
            ...
            setStat(prevDatas => {
                prevDatas.map(datas => {
                    const newNumCheck = prevDatas.numCheck
                    const newTotal = prevDatas.total+1
                    const newPercent = newNumCheck/newTotal * 100
                    return { ...datas, percent: newPercent, total: newTotal, numCheck: newNumCheck};
                });
                //...prevDatas, percent: newPercent, total: newTotal, numCheck: newNumCheck
            }
            );
